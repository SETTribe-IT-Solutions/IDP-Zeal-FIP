    ...
    <form id="issueForm" enctype="multipart/form-data">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="taluka" name="taluka" placeholder="तालुका नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" value="<?php echo htmlspecialchars($user_taluka); ?>" required>
            </div>

            <div class="form-group">
                <label><i class="fas fa-city"></i>गाव <span class="required">*</span></label>
                <input type="text" id="village" name="village" placeholder="गावाचे नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" value="<?php echo htmlspecialchars($user_village); ?>" required>
            </div>
...
function populateDesignations(selectedDept, selectedPosition = '') {
    positionSelect.innerHTML = '<option value="">-- निवडा पद --</option>';
...
function restorePrefilledValues() {
    ...
    // Populate designations based on department first, then pre-select designation
    populateDesignations(loggedInUser.department, loggedInUser.position);
