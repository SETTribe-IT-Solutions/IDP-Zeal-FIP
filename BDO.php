...
@media (max-width: 575.98px) {
    ...
    .table {
        width: 100% !important;
        min-width: 600px; /* force horizontal scroll if table has many columns */
    }
    .table th, .table td {
        white-space: nowrap;
    }
    ...
    /* Dashboard specific */
    .dashboard-stats .col, .stats-row .col,
...
@media (min-width: 576px) and (max-width: 991.98px) {
    ...
    .row > .col-md-6, .row > .col-sm-6 {
        flex: 0 0 50% !important;
        max-width: 50% !important;
    }
    .row > .col-md-4, .row > .col-sm-4 {
