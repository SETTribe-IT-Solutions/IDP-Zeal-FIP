    ...
    <form id="issueForm" enctype="multipart/form-data">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" id="taluka" name="taluka" placeholder="तालुका नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" required>
            </div>

            <div class="form-group">
                <label><i class="fas fa-city"></i>गाव <span class="required">*</span></label>
                <input type="text" id="village" name="village" placeholder="गावाचे नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" required>
            </div>

            <div class="form-group">
                <label><i class="fas fa-building"></i>विभाग / पंचायत समिती <span class="required">*</span></label>
                <input type="text" id="department" name="department" placeholder="विभागाचे नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" required>
            </div>

            <div class="form-group">
                <label><i class="fas fa-user-tie"></i>संबंधित विभाग प्रमुख <span class="required">*</span></label>
                <input type="text" id="deptHead" name="department_head" placeholder="विभाग प्रमुखाचे नाव" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="position" name="position" placeholder="आपले पद" pattern="[A-Za-z\u0900-\u097F ]+" title="कृपया फक्त अक्षरे आणि स्पेस वापरा" required>
            </div>
