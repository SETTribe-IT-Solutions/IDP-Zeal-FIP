...
// Fetch stats and recent items from DB (District Wide)
$total_issues = 0;
...
$user_display_name = $_SESSION['user_name'] ?? "CEO Officer";
...
<main class="main-content">
    ...
    <div class="welcome-container">
        ...
        <div class="welcome-info">
            <span class="welcome-badge">
                <i class="fa-solid fa-circle-check"></i> मुख्य कार्यकारी अधिकारी डॅशबोर्ड | CEO Dashboard
            </span>
            <h1 class="welcome-title">
                <span class="highlight"><?php echo htmlspecialchars($user_display_name); ?></span>
            </h1>
            <p class="welcome-desc">
                आपण जिल्हा परिषद हिंगोलीचे मुख्य कार्यकारी अधिकारी (CEO) म्हणून लॉग इन आहात. संपूर्ण जिल्ह्यातील प्रलंबित कामे, कार्यरत विभाग आणि समस्यांचे आकडे तपासा.
            </p>
        </div>
    ...
    <div class="stats-header">
        <h2><i class="fa-solid fa-chart-pie"></i> जिल्ह्यातील एकूण आकडेवारी (District-Wide Live Stats)</h2>
    ...
    <div class="section-container">
        <div class="recent-header">
            <h2 class="section-title"><i class="fa-solid fa-list-check"></i> जिल्ह्यातील अलीकडील समस्या (Recent District-Wide Issues)</h2>
        ...
        <div class="issues-table-card">
            ...
            <?php else: ?>
                <div class="empty-feed">
                    ...
                    <p>सध्या कोणतीही समस्या नोंदवलेली नाही.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
